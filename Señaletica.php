...
<div class="row services-box" style="background-image: url('images/LOGO/background.png');background-repeat:no-repeat;padding: 60px;">
        ...
        <section class="services py-lg-5 py-md-4 py-3" id="services">
          ...
          <img class="card-serv" src="Portafolio/neon/1.jpeg" alt="Letras-3D-Corporeas" class="imagea ">
          ...
          <a href="./Señaletica-Protecciion-civil.php">
            <div class="containera">
          <img class="card-serv" src="Portafolio/neon/2.jpg" alt="Letras-3D-Corporeas" class="imagea ">
            <h3 itemprop="services" style="color:#000;"><strong>Neon</strong></h3>
          ...
          <div class="col-md-3  text-center">
           <a href="./Señaletica-Protecciion-civil.php" style="color:#000;">
            <div class="containera">
            <img class="card-serv" src="Portafolio/neon/3.jfif" alt="Señaletica de interiores" class="imagea">
            <h3 itemprop="Services"style="color:#000;"><strong>Neon</strong></h3>
