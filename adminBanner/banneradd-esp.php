...
$insert=mysqli_query($con,"insert into banner_esp (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from banner_esp order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from banner_esp where id='$id_banner' limit 0,1");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
     ...
     <ol class="breadcrumb">
      ...
      <li><a href="bannerlist-esp.php">Galeria</a></li>
  ...
  <script>
      function upload_image(){
        ...
        $.ajax({
          url: "ajax/upload_banneresp.php",        // Url to which the request is send
