...
$insert=mysqli_query($con,"insert into banner_civil (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from banner_civil order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from banner_civil where id='$id_banner' limit 0,1");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		  ...
		  <li><a href="bannerlist-civil.php">Galeria</a></li>
	...
	<script>
			function upload_image(){
				...
				$.ajax({
					url: "ajax/upload_bannercivil.php",        // Url to which the request is send
	...
	<script>
		$("#editar_banner").submit(function(e) {
			  ...
			  $.ajax({
				  url: "ajax/editar_bannercivil.php",
				  type: "POST",
