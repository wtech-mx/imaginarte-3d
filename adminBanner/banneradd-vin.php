...
$insert=mysqli_query($con,"insert into banner_vin (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from banner_vin order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from banner_vin where id='$id_banner' limit 0,1");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		  ...
		  <li><a href="bannerlist-vin.php">Galeria</a></li>
	...
	<script>
			function upload_image(){
				...
				$.ajax({
					url: "ajax/upload_bannervin.php",        // Url to which the request is send
