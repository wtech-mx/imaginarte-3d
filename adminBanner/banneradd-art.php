...
$insert=mysqli_query($con,"insert into banner_art (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from banner_art order by id desc limit 0,1");
  ...
  <body>
	...
	<script>
			function upload_image(){
				...
				$.ajax({
					url: "ajax/upload_bannerart.php",        // Url to which the request is send
