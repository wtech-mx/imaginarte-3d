...
$insert=mysqli_query($con,"insert into banner_dvis (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from banner_dvis order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from banner_dvis where id='$id_banner' limit 0,1");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
     ...
     <ol class="breadcrumb">
      ...
      <li><a href="bannerlist-dvis.php">Galeria</a></li>
  ...
  <script>
      function upload_image(){
        ...
        $.ajax({
          url: "ajax/upload_bannerdvis.php",        // Url to which the request is send
  ...
  <script>
    $("#editar_banner").submit(function(e) {
        ...
        $.ajax({
          url: "ajax/editar_bannerdvis.php",
          type: "POST",
