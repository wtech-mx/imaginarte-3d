...
$sql=mysqli_query($con,"select * from banner_promo where id='$id_banner' limit 0,1");
  ...
  <body>
	...
	<script>
			function upload_image(){
				...
				$.ajax({
					url: "ajax/upload_bannerpromo.php",        // Url to which the request is send
	...
	<script>
		$("#editar_banner").submit(function(e) {
			  ...
			  $.ajax({
				  url: "ajax/editar_bannerpromo.php",
				  type: "POST",
