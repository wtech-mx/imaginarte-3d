...
<div class="row services-box" style="background-image: url('images/LOGO/background.png');background-repeat:no-repeat;padding: 60px;">
        ...
        <section class="services py-lg-5 py-md-4 py-3" id="services">
          ...
          <img class="card-serv" src="Portafolio/Serigrafia/11.jpeg" alt="Letras-3D-Corporeas" class="imagea ">
            <h3 itemprop="services" style="color:#000;"><strong>Serigrafia</strong></h3>
              <div class="overlaya">
          ...
          <a href="Promocionales.php">
            <div class="containera">
          <img class="card-serv" src="Portafolio/Serigrafia/6.jpeg" alt="Letras-3D-Corporeas" class="imagea ">
            <h3 itemprop="services" style="color:#000;"><strong>Serigrafia</strong></h3>
          ...
          <div class="col-md-3  text-center">
           <a href="Promocionales.php" style="color:#000;">
            <div class="containera">
            <img class="card-serv" src="Portafolio/Serigrafia/1.jpeg" alt="Señaletica de interiores" class="imagea">
            <h3 itemprop="Services"style="color:#000;"><strong>Serigrafia</strong></h3>
...
<div class="row services-box" style="background-image: url('images/LOGO/background2.png');background-repeat:no-repeat;padding: 60px;">
        ...
        <section class="services py-lg-5 py-md-4 py-3" id="services">
          ...
          <a href="Promocionales.php">
            <div class="containera">
          <img class="card-serv" src="Portafolio/Serigrafia/145.jpeg" alt="Letras-3D-Corporeas" class="imagea ">
            <h3 itemprop="services" style="color:#000;"><strong>Sublimacion</strong></h3>
              <div class="overlaya">
                <div class="texta">Ver más <br>
                  <strong>Click aqui</strong> 
                </div>
          ...
          <a href="Promocionales.php">
            <div class="containera">
          <img class="card-serv" src="Portafolio/Serigrafia/s1.png" alt="Letras-3D-Corporeas" class="imagea ">
            <h3 itemprop="services" style="color:#000;"><strong>Sublimacion</strong></h3>
              <div class="overlaya yellow">
                <div class="texta">Ver más <br>
                  <strong>Para sorprenderte dale click</strong> 
          ...
          <div class="col-md-3  text-center">
           <a href="Promocionales.php" style="color:#000;">
            <div class="containera">
            <img class="card-serv" src="Portafolio/Serigrafia/4.jpeg" alt="Señaletica de interiores" class="imagea">
            <h3 itemprop="Services"style="color:#000;"><strong>Sublimacion</strong></h3>
              <div class="overlaya porple">
                <div class="texta">Ver más<br>
                  <strong>Pare ver da click aqui</strong> </div>
